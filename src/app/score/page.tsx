...
import { Step } from "../components/TourGuide";
...
const Score = () => {
  ...
  const walkSteps: Step[] = [
    {
      selector: '[data-tour="traits"]',
      content: "This is where the athlete see their mental attribute scores.",
      placement: "bottom",
    },
    {
      selector: '[data-tour="coachbot"]',
      content:
        "If the athlete has questions about their scores, best practices or any materials - they can ask the chatbot.'",
      placement: "top",
    },
    {
      selector: '[data-tour="skills"]',
      content:
        "The athlete also sees what the coach wants the team to focus on.",
      placement: "top",
    },
    {
      selector: '[data-tour="checkin"]',
      content:
        "Throughout the week, they'll have check-ins to help monitor and improve their mental attribute scores over time. Click 'Discover' to see how a check-in works.",
      placement: "top",
    },
  ];
    ...
    <>
      ...
      <div className='text-white mt-15 px-4 sm:px-0 '>
        <div className='max-w-[640px] mx-auto'>
          ...
          <div
            className='mt-2 bg-black/20 border border-white/20 p-2.5 w-157 rounded-xl flex items-center space-x-1'
            data-tour='coachbot'
          >
          ...
          <div className='mt-12 relative' data-tour='checkin'>
            ...
            >
              ...
              <p className='text-md mb-4 text-gray-300'>
                ...
                {selectedIndex === 1
                  ...
                  ? "Execute"
                  : ""}
                , please finish the first step of your journey — "Reflection".
                It helps lay the foundation for everything that follows.
              </p>
